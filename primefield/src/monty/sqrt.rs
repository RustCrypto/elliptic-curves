...
// TODO(tarcieri): Atkins' algorithm
...
/// Compute the residue class of the modulus for the purposes of selecting a particular modular
...
// TODO(tarcieri): test selection of sqrt algorithms based on the modulus
#[cfg(test)]
mod tests {
