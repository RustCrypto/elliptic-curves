...
use super::{
    AffineMontgomeryPoint, DEFAULT_ENCODE_TO_CURVE_SUITE, DEFAULT_HASH_TO_CURVE_SUITE,
    MontgomeryScalar, ProjectiveMontgomeryPoint,
};
use crate::field::{ConstMontyType, FieldElement, FieldElementU84};
...
impl ProjectiveMontgomeryXpoint {
        ...
        X: ExpandMsg<U28>,
    {
        ...
        let q0 = Curve448::map_to_curve(FieldElementU84(u0));
        let q1 = Curve448::map_to_curve(FieldElementU84(u1));

        Self::from(q0 + q1).double().double()
    }
