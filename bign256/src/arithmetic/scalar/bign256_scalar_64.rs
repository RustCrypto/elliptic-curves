//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline bign256_scalar 64 '2^256 - 51359303463308904523350978545619999225' mul square add sub opp from_montgomery to_montgomery selectznz msat divstep divstep_precomp
...
#[derive(Clone, Copy)]
pub struct fiat_bign256_scalar_montgomery_domain_field_element(pub [u64; 4]);
...
/** Bounds: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]] */
#[derive(Clone, Copy)]
pub struct fiat_bign256_scalar_non_montgomery_domain_field_element(pub [u64; 4]);
...
/// The function fiat_bign256_scalar_addcarryx_u64 is an addition with carry.
///
/// Postconditions:
...
/// The function fiat_bign256_scalar_subborrowx_u64 is a subtraction with borrow.
///
/// Postconditions:
///   out1 = (-arg1 + arg2 + -arg3) mod 2^64
///   out2 = -⌊(-arg1 + arg2 + -arg3) / 2^64⌋
...
/// The function fiat_bign256_scalar_mulx_u64 is a multiplication, returning the full double-width result.
///
/// Postconditions:
...
#[inline]
pub const fn fiat_bign256_scalar_mulx_u64(out1: &mut u64, out2: &mut u64, arg1: u64, arg2: u64) {
...
/// The function fiat_bign256_scalar_cmovznz_u64 is a single-word conditional move.
///
/// Postconditions:
...
pub const fn fiat_bign256_scalar_mul(
    ...
    let mut x5: u64 = 0;
    let mut x6: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg2).index(3)));
    let mut x7: u64 = 0;
    let mut x8: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x7, &mut x8, x4, (*IndexConst(arg2).index(2)));
    let mut x9: u64 = 0;
    let mut x10: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x9, &mut x10, x4, (*IndexConst(arg2).index(1)));
    let mut x11: u64 = 0;
    let mut x12: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x11, &mut x12, x4, (*IndexConst(arg2).index(0)));
    let mut x13: u64 = 0;
    ...
    let mut x47: u64 = 0;
    let mut x48: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x47, &mut x48, x1, (*IndexConst(arg2).index(3)));
    let mut x49: u64 = 0;
    let mut x50: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x49, &mut x50, x1, (*IndexConst(arg2).index(2)));
    let mut x51: u64 = 0;
    let mut x52: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x51, &mut x52, x1, (*IndexConst(arg2).index(1)));
    let mut x53: u64 = 0;
    let mut x54: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x53, &mut x54, x1, (*IndexConst(arg2).index(0)));
    let mut x55: u64 = 0;
    ...
    let mut x100: u64 = 0;
    let mut x101: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x100, &mut x101, x2, (*IndexConst(arg2).index(3)));
    let mut x102: u64 = 0;
    let mut x103: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x102, &mut x103, x2, (*IndexConst(arg2).index(2)));
    let mut x104: u64 = 0;
    let mut x105: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x104, &mut x105, x2, (*IndexConst(arg2).index(1)));
    let mut x106: u64 = 0;
    let mut x107: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x106, &mut x107, x2, (*IndexConst(arg2).index(0)));
    let mut x108: u64 = 0;
    ...
    let mut x153: u64 = 0;
    let mut x154: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x153, &mut x154, x3, (*IndexConst(arg2).index(3)));
    let mut x155: u64 = 0;
    let mut x156: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x155, &mut x156, x3, (*IndexConst(arg2).index(2)));
    let mut x157: u64 = 0;
    let mut x158: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x157, &mut x158, x3, (*IndexConst(arg2).index(1)));
    let mut x159: u64 = 0;
    let mut x160: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x159, &mut x160, x3, (*IndexConst(arg2).index(0)));
    let mut x161: u64 = 0;
...
pub const fn fiat_bign256_scalar_square(
    ...
    let mut x5: u64 = 0;
    let mut x6: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x5, &mut x6, x4, (*IndexConst(arg1).index(3)));
    let mut x7: u64 = 0;
    let mut x8: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x7, &mut x8, x4, (*IndexConst(arg1).index(2)));
    let mut x9: u64 = 0;
    let mut x10: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x9, &mut x10, x4, (*IndexConst(arg1).index(1)));
    let mut x11: u64 = 0;
    let mut x12: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x11, &mut x12, x4, (*IndexConst(arg1).index(0)));
    let mut x13: u64 = 0;
    let mut x14: fiat_bign256_scalar_u1 = 0;
    fiat_bign256_scalar_addcarryx_u64(&mut x13, &mut x14, 0x0, x12, x9);
    let mut x15: u64 = 0;
    ...
    let mut x47: u64 = 0;
    let mut x48: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x47, &mut x48, x1, (*IndexConst(arg1).index(3)));
    let mut x49: u64 = 0;
    let mut x50: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x49, &mut x50, x1, (*IndexConst(arg1).index(2)));
    let mut x51: u64 = 0;
    let mut x52: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x51, &mut x52, x1, (*IndexConst(arg1).index(1)));
    let mut x53: u64 = 0;
    let mut x54: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x53, &mut x54, x1, (*IndexConst(arg1).index(0)));
    let mut x55: u64 = 0;
    let mut x56: fiat_bign256_scalar_u1 = 0;
    fiat_bign256_scalar_addcarryx_u64(&mut x55, &mut x56, 0x0, x54, x51);
    let mut x57: u64 = 0;
    ...
    let mut x100: u64 = 0;
    let mut x101: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x100, &mut x101, x2, (*IndexConst(arg1).index(3)));
    let mut x102: u64 = 0;
    let mut x103: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x102, &mut x103, x2, (*IndexConst(arg1).index(2)));
    let mut x104: u64 = 0;
    let mut x105: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x104, &mut x105, x2, (*IndexConst(arg1).index(1)));
    let mut x106: u64 = 0;
    let mut x107: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x106, &mut x107, x2, (*IndexConst(arg1).index(0)));
    let mut x108: u64 = 0;
    let mut x109: fiat_bign256_scalar_u1 = 0;
    fiat_bign256_scalar_addcarryx_u64(&mut x108, &mut x109, 0x0, x107, x104);
    let mut x110: u64 = 0;
    ...
    let mut x153: u64 = 0;
    let mut x154: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x153, &mut x154, x3, (*IndexConst(arg1).index(3)));
    let mut x155: u64 = 0;
    let mut x156: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x155, &mut x156, x3, (*IndexConst(arg1).index(2)));
    let mut x157: u64 = 0;
    let mut x158: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x157, &mut x158, x3, (*IndexConst(arg1).index(1)));
    let mut x159: u64 = 0;
    let mut x160: u64 = 0;
    fiat_bign256_scalar_mulx_u64(&mut x159, &mut x160, x3, (*IndexConst(arg1).index(0)));
    let mut x161: u64 = 0;
    let mut x162: fiat_bign256_scalar_u1 = 0;
    fiat_bign256_scalar_addcarryx_u64(&mut x161, &mut x162, 0x0, x160, x157);
    let mut x163: u64 = 0;
...
pub const fn fiat_bign256_scalar_from_montgomery(
    ...
    fiat_bign256_scalar_addcarryx_u64(&mut x28, &mut x29, 0x0, x20, (*IndexConst(arg1).index(1)));
    let mut x30: u64 = 0;
    let mut x31: fiat_bign256_scalar_u1 = 0;
    ...
    let mut x62: u64 = 0;
    let mut x63: fiat_bign256_scalar_u1 = 0;
    fiat_bign256_scalar_addcarryx_u64(&mut x62, &mut x63, 0x0, x54, (*IndexConst(arg1).index(2)));
    let mut x64: u64 = 0;
    let mut x65: fiat_bign256_scalar_u1 = 0;
    ...
    fiat_bign256_scalar_addcarryx_u64(&mut x96, &mut x97, 0x0, x88, (*IndexConst(arg1).index(3)));
    let mut x98: u64 = 0;
...
pub const fn fiat_bign256_scalar_selectznz(
    ...
    let mut x1: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(
        &mut x1,
        arg1,
        (*IndexConst(arg2).index(0)),
...
#[inline]
pub const fn fiat_bign256_scalar_msat(mut out1: &mut [u64; 5]) {
...
pub const fn fiat_bign256_scalar_divstep(
    ...
    let x3: fiat_bign256_scalar_u1 = (((x1 >> 63) as fiat_bign256_scalar_u1)
        & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_bign256_scalar_u1));
    let mut x4: u64 = 0;
    ...
    let mut x22: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x22, x3, (*IndexConst(arg3).index(0)), x12);
    let mut x23: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x23, x3, (*IndexConst(arg3).index(1)), x14);
    let mut x24: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x24, x3, (*IndexConst(arg3).index(2)), x16);
    let mut x25: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x25, x3, (*IndexConst(arg3).index(3)), x18);
    let mut x26: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x26, x3, (*IndexConst(arg3).index(4)), x20);
    let mut x27: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(
        &mut x27,
        x3,
    ...
    let mut x70: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x70, x3, (*IndexConst(arg5).index(0)), x62);
    let mut x71: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x71, x3, (*IndexConst(arg5).index(1)), x64);
    let mut x72: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x72, x3, (*IndexConst(arg5).index(2)), x66);
    let mut x73: u64 = 0;
    fiat_bign256_scalar_cmovznz_u64(&mut x73, x3, (*IndexConst(arg5).index(3)), x68);
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_bign256_scalar_divstep_precomp(mut out1: &mut [u64; 4]) {
