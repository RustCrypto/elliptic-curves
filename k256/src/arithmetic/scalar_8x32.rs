...
#[cfg(test)]
use super::util::{u32_array_to_biguint, biguint_to_u32_array};
...
impl Scalar8x32 {
    ...
    pub fn add(&self, rhs: &Self) -> Self {
        ...
        let r0 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[1] as u64 + rhs.0[1] as u64;
        let r1 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[2] as u64 + rhs.0[2] as u64;
        let r2 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[3] as u64 + rhs.0[3] as u64;
        let r3 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[4] as u64 + rhs.0[4] as u64;
        let r4 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[5] as u64 + rhs.0[5] as u64;
        let r5 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[6] as u64 + rhs.0[6] as u64;
        let r6 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
        t += self.0[7] as u64 + rhs.0[7] as u64;
        let r7 = (t & 0xFFFFFFFFu64) as u32; t >>= 32;
...
impl WideScalar {
    ...
    pub fn reduce(&self) -> Scalar8x32 {
        ...
        let (m10, c0, c1, c2) = (c0, c1, c2, 0);
        let (c0, c1) = sumadd_fast(n7, c0, c1);
        let (m11, c0, c1) = (c0, c1, 0);
        debug_assert!(c0 <= 1);
        let m12 = c0;
        ...
        let r0 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p1 as u64 + (NEG_MODULUS[1] as u64) * (p8 as u64);
        let r1 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p2 as u64 + (NEG_MODULUS[2] as u64) * (p8 as u64);
        let r2 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p3 as u64 + (NEG_MODULUS[3] as u64) * (p8 as u64);
        let r3 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p4 as u64 + p8 as u64;
        let r4 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p5 as u64;
        let r5 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p6 as u64;
        let r6 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
        c += p7 as u64;
        let r7 = (c & 0xFFFFFFFFu64) as u32; c >>= 32;
