...
impl hash2curve::GroupDigest for NistP384 {
    const HASH_TO_CURVE_DST: &[u8] = b"P384_XMD:SHA-384_SSWU_RO_";
    const ENCODE_TO_CURVE_DST: &[u8] = b"P384_XMD:SHA-384_SSWU_NU_";
    ...
    fn hash_to_scalar_voprf() {
        ...
        'outer: for test_vector in TEST_VECTORS {
            ...
            for counter in 0_u8..=u8::MAX {
                let scalar = hash2curve::hash_to_scalar::<NistP384, ExpandMsgXmd<Sha384>>(
                    &[
                        test_vector.seed,
                        &key_info_len,
