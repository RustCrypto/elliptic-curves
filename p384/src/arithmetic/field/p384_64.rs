...
pub const fn fiat_p384_cmovznz_u64(arg1: fiat_p384_u1, arg2: u64, arg3: u64) -> u64 {
    ...
    let x2: u64 = ((((((0x0 as fiat_p384_i2) - (x1 as fiat_p384_i2)) as fiat_p384_i1)
...
pub const fn fiat_p384_mul(
    ...
    (fiat_p384_montgomery_domain_field_element([x468, x469, x470, x471, x472, x473]))
}
...
pub const fn fiat_p384_add(
    ...
    (fiat_p384_montgomery_domain_field_element([x27, x28, x29, x30, x31, x32]))
}
...
pub const fn fiat_p384_sub(
    ...
    (fiat_p384_montgomery_domain_field_element([x14, x16, x18, x20, x22, x24]))
}
...
pub const fn fiat_p384_from_montgomery(
    ...
    let (x88, x89) = fiat_p384_addcarryx_u64(
        x87,
    ...
    let (x138, x139) = fiat_p384_addcarryx_u64(
        x137,
    ...
    (fiat_p384_non_montgomery_domain_field_element([x304, x305, x306, x307, x308, x309]))
}
...
pub const fn fiat_p384_to_montgomery(
    ...
    let (x125, x126) = fiat_p384_addcarryx_u64(
        x124,
    ...
    (fiat_p384_montgomery_domain_field_element([x405, x406, x407, x408, x409, x410]))
}
...
pub const fn fiat_p384_divstep(
    ...
    let x3: fiat_p384_u1 = (((x1 >> 63) as fiat_p384_u1)
        & (((arg3[0]) & (0x1 as u64)) as fiat_p384_u1));
