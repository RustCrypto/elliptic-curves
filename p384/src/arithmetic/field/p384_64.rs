...
//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub const fn fiat_p384_nonzero(out1: &mut u64, arg1: &[u64; 6]) {
...
#[inline]
pub const fn fiat_p384_to_bytes(out1: &mut [u8; 48], arg1: &[u64; 6]) {
    let x1: u64 = (arg1[5]);
    let x2: u64 = (arg1[4]);
    let x3: u64 = (arg1[3]);
    let x4: u64 = (arg1[2]);
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p384_from_bytes(out1: &mut [u64; 6], arg1: &[u8; 48]) {
...
#[inline]
pub const fn fiat_p384_msat(out1: &mut [u64; 7]) {
    out1[0] = 0xffffffff;
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p384_divstep_precomp(out1: &mut [u64; 6]) {
