...
impl core::ops::IndexMut<usize>
for fiat_p384_scalar_non_montgomery_domain_field_element {
    #[inline]
    fn index_mut(&mut self, index: usize) -> &mut Self::Output {
        &mut self.0[index]
    }
...
pub const fn fiat_p384_scalar_subborrowx_u64(
    ...
    (
        x3,
        (((0x0 as fiat_p384_scalar_i2) - (x2 as fiat_p384_scalar_i2))
            as fiat_p384_scalar_u1),
    )
}
...
pub const fn fiat_p384_scalar_cmovznz_u64(
    ...
    let x2: u64 = ((((((0x0 as fiat_p384_scalar_i2) - (x1 as fiat_p384_scalar_i2))
        as fiat_p384_scalar_i1) as i128) & (0xffffffffffffffff as i128)) as u64);
...
pub const fn fiat_p384_scalar_mul(
    ...
    let (x466, x467) = fiat_p384_scalar_subborrowx_u64(x465, x453, (0x0 as u64));
...
pub const fn fiat_p384_scalar_add(
    ...
    let (x25, x26) = fiat_p384_scalar_subborrowx_u64(x24, (x12 as u64), (0x0 as u64));
    ...
    (fiat_p384_scalar_montgomery_domain_field_element([x27, x28, x29, x30, x31, x32]))
}
...
pub const fn fiat_p384_scalar_sub(
    ...
    let (x13) = fiat_p384_scalar_cmovznz_u64(x12, (0x0 as u64), 0xffffffffffffffff);
    ...
    (fiat_p384_scalar_montgomery_domain_field_element([x14, x16, x18, x20, x22, x24]))
}
...
pub const fn fiat_p384_scalar_opp(
    ...
    let arg1 = arg1.as_inner();
    let (x1, x2) = fiat_p384_scalar_subborrowx_u64(0x0, (0x0 as u64), (arg1[0]));
    let (x3, x4) = fiat_p384_scalar_subborrowx_u64(x2, (0x0 as u64), (arg1[1]));
    let (x5, x6) = fiat_p384_scalar_subborrowx_u64(x4, (0x0 as u64), (arg1[2]));
    let (x7, x8) = fiat_p384_scalar_subborrowx_u64(x6, (0x0 as u64), (arg1[3]));
    let (x9, x10) = fiat_p384_scalar_subborrowx_u64(x8, (0x0 as u64), (arg1[4]));
    let (x11, x12) = fiat_p384_scalar_subborrowx_u64(x10, (0x0 as u64), (arg1[5]));
    let (x13) = fiat_p384_scalar_cmovznz_u64(x12, (0x0 as u64), 0xffffffffffffffff);
    let (x14, x15) = fiat_p384_scalar_addcarryx_u64(0x0, x1, (x13 & 0xecec196accc52973));
    let (x16, x17) = fiat_p384_scalar_addcarryx_u64(x15, x3, (x13 & 0x581a0db248b0a77a));
    let (x18, x19) = fiat_p384_scalar_addcarryx_u64(x17, x5, (x13 & 0xc7634d81f4372ddf));
...
pub const fn fiat_p384_scalar_from_montgomery(
    ...
    let (x28, x29) = fiat_p384_scalar_addcarryx_u64(x27, (0x0 as u64), x16);
    let (x30, x31) = fiat_p384_scalar_addcarryx_u64(x29, (0x0 as u64), x18);
    let (x32, x33) = fiat_p384_scalar_addcarryx_u64(x31, (0x0 as u64), x20);
    let (x34, x35) = fiat_p384_scalar_addcarryx_u64(x33, (0x0 as u64), x22);
    let (x36, x37) = fiat_p384_scalar_addcarryx_u64(x35, (0x0 as u64), x24);
    let (x38, x39) = fiat_p384_scalar_addcarryx_u64(
        x37,
        (0x0 as u64),
        ((x25 as u64) + x5),
    );
    let (x40, x41) = fiat_p384_scalar_addcarryx_u64(0x0, x28, (arg1[1]));
    let (x42, x43) = fiat_p384_scalar_addcarryx_u64(x41, x30, (0x0 as u64));
    let (x44, x45) = fiat_p384_scalar_addcarryx_u64(x43, x32, (0x0 as u64));
    let (x46, x47) = fiat_p384_scalar_addcarryx_u64(x45, x34, (0x0 as u64));
    let (x48, x49) = fiat_p384_scalar_addcarryx_u64(x47, x36, (0x0 as u64));
    let (x50, x51) = fiat_p384_scalar_addcarryx_u64(x49, x38, (0x0 as u64));
    ...
    let (x88, x89) = fiat_p384_scalar_addcarryx_u64(
        x87,
        ((x51 as u64) + (x39 as u64)),
        ((x75 as u64) + x55),
    );
    let (x90, x91) = fiat_p384_scalar_addcarryx_u64(0x0, x78, (arg1[2]));
    let (x92, x93) = fiat_p384_scalar_addcarryx_u64(x91, x80, (0x0 as u64));
    let (x94, x95) = fiat_p384_scalar_addcarryx_u64(x93, x82, (0x0 as u64));
    let (x96, x97) = fiat_p384_scalar_addcarryx_u64(x95, x84, (0x0 as u64));
    let (x98, x99) = fiat_p384_scalar_addcarryx_u64(x97, x86, (0x0 as u64));
    let (x100, x101) = fiat_p384_scalar_addcarryx_u64(x99, x88, (0x0 as u64));
    ...
    let (x142, x143) = fiat_p384_scalar_addcarryx_u64(x141, x130, (0x0 as u64));
    let (x144, x145) = fiat_p384_scalar_addcarryx_u64(x143, x132, (0x0 as u64));
    let (x146, x147) = fiat_p384_scalar_addcarryx_u64(x145, x134, (0x0 as u64));
    let (x148, x149) = fiat_p384_scalar_addcarryx_u64(x147, x136, (0x0 as u64));
    let (x150, x151) = fiat_p384_scalar_addcarryx_u64(x149, x138, (0x0 as u64));
    ...
    let (x192, x193) = fiat_p384_scalar_addcarryx_u64(x191, x180, (0x0 as u64));
    let (x194, x195) = fiat_p384_scalar_addcarryx_u64(x193, x182, (0x0 as u64));
    let (x196, x197) = fiat_p384_scalar_addcarryx_u64(x195, x184, (0x0 as u64));
    let (x198, x199) = fiat_p384_scalar_addcarryx_u64(x197, x186, (0x0 as u64));
    let (x200, x201) = fiat_p384_scalar_addcarryx_u64(x199, x188, (0x0 as u64));
    ...
    let (x242, x243) = fiat_p384_scalar_addcarryx_u64(x241, x230, (0x0 as u64));
    let (x244, x245) = fiat_p384_scalar_addcarryx_u64(x243, x232, (0x0 as u64));
    let (x246, x247) = fiat_p384_scalar_addcarryx_u64(x245, x234, (0x0 as u64));
    let (x248, x249) = fiat_p384_scalar_addcarryx_u64(x247, x236, (0x0 as u64));
    let (x250, x251) = fiat_p384_scalar_addcarryx_u64(x249, x238, (0x0 as u64));
    ...
    let (x302, x303) = fiat_p384_scalar_subborrowx_u64(
        x301,
        (x289 as u64),
        (0x0 as u64),
    );
...
pub const fn fiat_p384_scalar_to_montgomery(
    ...
    let (x65, x66) = fiat_p384_scalar_addcarryx_u64(
        x64,
        ((x28 as u64) + x8),
        ((x52 as u64) + x32),
    );
    ...
    let (x439, x440) = fiat_p384_scalar_subborrowx_u64(
        x438,
        (x426 as u64),
        (0x0 as u64),
    );
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub const fn fiat_p384_scalar_nonzero(arg1: &[u64; 6]) -> u64 {
    let x1: u64 = ((arg1[0])
...
pub const fn fiat_p384_scalar_divstep(
    ...
    let (x1, x2) = fiat_p384_scalar_addcarryx_u64(0x0, (!arg1), (0x1 as u64));
    let x3: fiat_p384_scalar_u1 = (((x1 >> 63) as fiat_p384_scalar_u1)
        & (((arg3[0]) & (0x1 as u64)) as fiat_p384_scalar_u1));
    let (x4, x5) = fiat_p384_scalar_addcarryx_u64(0x0, (!arg1), (0x1 as u64));
    ...
    let (x14, x15) = fiat_p384_scalar_addcarryx_u64(0x0, (0x1 as u64), (!(arg2[0])));
    let (x16, x17) = fiat_p384_scalar_addcarryx_u64(x15, (0x0 as u64), (!(arg2[1])));
    let (x18, x19) = fiat_p384_scalar_addcarryx_u64(x17, (0x0 as u64), (!(arg2[2])));
    let (x20, x21) = fiat_p384_scalar_addcarryx_u64(x19, (0x0 as u64), (!(arg2[3])));
    let (x22, x23) = fiat_p384_scalar_addcarryx_u64(x21, (0x0 as u64), (!(arg2[4])));
    let (x24, x25) = fiat_p384_scalar_addcarryx_u64(x23, (0x0 as u64), (!(arg2[5])));
    let (x26, x27) = fiat_p384_scalar_addcarryx_u64(x25, (0x0 as u64), (!(arg2[6])));
    ...
    let (x65, x66) = fiat_p384_scalar_subborrowx_u64(x64, (x52 as u64), (0x0 as u64));
    let x67: u64 = (arg4[5]);
    let x68: u64 = (arg4[4]);
    let x69: u64 = (arg4[3]);
    let x70: u64 = (arg4[2]);
    let x71: u64 = (arg4[1]);
    let x72: u64 = (arg4[0]);
    let (x73, x74) = fiat_p384_scalar_subborrowx_u64(0x0, (0x0 as u64), x72);
    let (x75, x76) = fiat_p384_scalar_subborrowx_u64(x74, (0x0 as u64), x71);
    let (x77, x78) = fiat_p384_scalar_subborrowx_u64(x76, (0x0 as u64), x70);
    let (x79, x80) = fiat_p384_scalar_subborrowx_u64(x78, (0x0 as u64), x69);
    let (x81, x82) = fiat_p384_scalar_subborrowx_u64(x80, (0x0 as u64), x68);
    let (x83, x84) = fiat_p384_scalar_subborrowx_u64(x82, (0x0 as u64), x67);
    let (x85) = fiat_p384_scalar_cmovznz_u64(x84, (0x0 as u64), 0xffffffffffffffff);
    let (x86, x87) = fiat_p384_scalar_addcarryx_u64(
        0x0,
        x73,
        (x85 & 0xecec196accc52973),
    );
    let (x88, x89) = fiat_p384_scalar_addcarryx_u64(
        x87,
        x75,
        (x85 & 0x581a0db248b0a77a),
    );
    let (x90, x91) = fiat_p384_scalar_addcarryx_u64(
        x89,
        x77,
        (x85 & 0xc7634d81f4372ddf),
    );
    ...
    let (x105) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x7);
    let (x106) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x8);
    let (x107) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x9);
    let (x108) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x10);
    let (x109) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x11);
    let (x110) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x12);
    let (x111) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x13);
    ...
    let (x126) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x35);
    let (x127) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x36);
    let (x128) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x37);
    let (x129) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x38);
    let (x130) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x39);
    let (x131) = fiat_p384_scalar_cmovznz_u64(x104, (0x0 as u64), x40);
    ...
    let (x156, x157) = fiat_p384_scalar_subborrowx_u64(
        x155,
        (x143 as u64),
        (0x0 as u64),
    );
    let (x158, x159) = fiat_p384_scalar_addcarryx_u64(0x0, x6, (0x1 as u64));
...
impl fiat_p384_scalar_montgomery_domain_field_element {
    #[inline]
    pub const fn as_inner(&self) -> &[u64; 6] {
        &self.0
    }
    #[inline]
    pub const fn into_inner(self) -> [u64; 6] {
        self.0
    }
}
impl fiat_p384_scalar_non_montgomery_domain_field_element {
    #[inline]
    pub const fn as_inner(&self) -> &[u64; 6] {
        &self.0
    }
