//! Autogenerated: './word_by_word_montgomery' --lang Rust --inline p384_scalar
//! 64 39402006196394479212279040100143613805079739270465446667946905279627659399113263569398956308152294913554433653942643
//! curve description: p384_scalar
//! machine_wordsize = 64 (from "64")
//! requested operations: (all)
//! m = 0xffffffffffffffffffffffffffffffffffffffffffffffffc7634d81f4372ddf581a0db248b0a77aecec196accc52973 (from "39402006196394479212279040100143613805079739270465446667946905279627659399113263569398956308152294913554433653942643")
//!
...
//! 256) + (z[5] << 0x140)   bytes_eval z = z[0] + (z[1] << 8) + (z[2] << 16) +
//! (z[3] << 24) + (z[4] << 32) + (z[5] << 40) + (z[6] << 48) + (z[7] << 56) +
//! (z[8] << 64) + (z[9] << 72) + (z[10] << 80) + (z[11] << 88) + (z[12] << 96)
//! + (z[13] << 104) + (z[14] << 112) + (z[15] << 120) + (z[16] << 128) + (z[17]
//! << 136) + (z[18] << 144) + (z[19] << 152) + (z[20] << 160) + (z[21] << 168)
//! + (z[22] << 176) + (z[23] << 184) + (z[24] << 192) + (z[25] << 200) + (z[26]
//! << 208) + (z[27] << 216) + (z[28] << 224) + (z[29] << 232) + (z[30] << 240)
//! + (z[31] << 248) + (z[32] << 256) + (z[33] << 0x108) + (z[34] << 0x110) +
//! (z[35] << 0x118) + (z[36] << 0x120) + (z[37] << 0x128) + (z[38] << 0x130) +
//! (z[39] << 0x138) + (z[40] << 0x140) + (z[41] << 0x148) + (z[42] << 0x150) +
//! (z[43] << 0x158) + (z[44] << 0x160) + (z[45] << 0x168) + (z[46] << 0x170) +
//! (z[47] << 0x178)   twos_complement_eval z = let x1 := z[0] + (z[1] << 64) +
//! (z[2] << 128) + (z[3] << 192) + (z[4] << 256) + (z[5] << 0x140) in
//!                            if x1 & (2^384-1) < 2^383 then x1 & (2^384-1)
//! else (x1 & (2^384-1)) - 2^384
...
// The type fiat_p384_scalar_montgomery_domain_field_element is a field element
...
// The type fiat_p384_scalar_non_montgomery_domain_field_element is a field
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p384_scalar_addcarryx_u64(
    out1: &mut u64,
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p384_scalar_subborrowx_u64(
    out1: &mut u64,
    out2: &mut fiat_p384_scalar_u1,
    arg1: fiat_p384_scalar_u1,
    arg2: u64,
...
/// The function fiat_p384_scalar_mulx_u64 is a multiplication, returning the
/// full double-width result.
///
/// Postconditions:
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub fn fiat_p384_scalar_cmovznz_u64(
    out1: &mut u64,
    arg1: fiat_p384_scalar_u1,
    arg2: u64,
    arg3: u64,
...
/// The function fiat_p384_scalar_mul multiplies two field elements in the
/// Montgomery domain.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
...
pub fn fiat_p384_scalar_mul(
    ...
    fiat_p384_scalar_subborrowx_u64(&mut x466, &mut x467, x465, x453, 0x0_u64);
    let mut x468: u64 = 0;
...
/// The function fiat_p384_scalar_square squares a field element in the
/// Montgomery domain.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
...
#[inline]
pub fn fiat_p384_scalar_square(
    out1: &mut fiat_p384_scalar_montgomery_domain_field_element,
    arg1: &fiat_p384_scalar_montgomery_domain_field_element,
) {
    let x1: u64 = (arg1[1]);
...
/// The function fiat_p384_scalar_add adds two field elements in the Montgomery
/// domain.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
...
pub fn fiat_p384_scalar_add(
    ...
    let mut x25: u64 = 0;
    let mut x26: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x25, &mut x26, x24, (x12 as u64), 0x0_u64);
    let mut x27: u64 = 0;
...
/// The function fiat_p384_scalar_sub subtracts two field elements in the
/// Montgomery domain.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
...
pub fn fiat_p384_scalar_sub(
    ...
    let mut x13: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x13, x12, 0x0_u64, 0xffffffffffffffff);
    let mut x14: u64 = 0;
...
/// The function fiat_p384_scalar_opp negates a field element in the Montgomery
/// domain.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
...
///   0 ≤ eval out1 < m
#[inline]
pub fn fiat_p384_scalar_opp(
    out1: &mut fiat_p384_scalar_montgomery_domain_field_element,
    arg1: &fiat_p384_scalar_montgomery_domain_field_element,
) {
    let mut x1: u64 = 0;
    let mut x2: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x1, &mut x2, 0x0, 0x0_u64, (arg1[0]));
    let mut x3: u64 = 0;
    let mut x4: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x3, &mut x4, x2, 0x0_u64, (arg1[1]));
    let mut x5: u64 = 0;
    let mut x6: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x5, &mut x6, x4, 0x0_u64, (arg1[2]));
    let mut x7: u64 = 0;
    let mut x8: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x7, &mut x8, x6, 0x0_u64, (arg1[3]));
    let mut x9: u64 = 0;
    let mut x10: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x9, &mut x10, x8, 0x0_u64, (arg1[4]));
    let mut x11: u64 = 0;
    let mut x12: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x11, &mut x12, x10, 0x0_u64, (arg1[5]));
    let mut x13: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x13, x12, 0x0_u64, 0xffffffffffffffff);
    let mut x14: u64 = 0;
    let mut x15: fiat_p384_scalar_u1 = 0;
...
/// The function fiat_p384_scalar_from_montgomery translates a field element out
/// of the Montgomery domain.
///
/// Preconditions:
///   0 ≤ eval arg1 < m
/// Postconditions:
...
///   0 ≤ eval out1 < m
#[inline]
pub fn fiat_p384_scalar_from_montgomery(
    ...
    fiat_p384_scalar_addcarryx_u64(&mut x28, &mut x29, x27, 0x0_u64, x16);
    let mut x30: u64 = 0;
    let mut x31: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x30, &mut x31, x29, 0x0_u64, x18);
    let mut x32: u64 = 0;
    let mut x33: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x32, &mut x33, x31, 0x0_u64, x20);
    let mut x34: u64 = 0;
    let mut x35: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x34, &mut x35, x33, 0x0_u64, x22);
    let mut x36: u64 = 0;
    let mut x37: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x36, &mut x37, x35, 0x0_u64, x24);
    let mut x38: u64 = 0;
    let mut x39: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x38, &mut x39, x37, 0x0_u64, ((x25 as u64) + x5));
    let mut x40: u64 = 0;
    ...
    fiat_p384_scalar_addcarryx_u64(&mut x42, &mut x43, x41, x30, 0x0_u64);
    let mut x44: u64 = 0;
    let mut x45: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x44, &mut x45, x43, x32, 0x0_u64);
    let mut x46: u64 = 0;
    let mut x47: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x46, &mut x47, x45, x34, 0x0_u64);
    let mut x48: u64 = 0;
    let mut x49: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x48, &mut x49, x47, x36, 0x0_u64);
    let mut x50: u64 = 0;
    let mut x51: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x50, &mut x51, x49, x38, 0x0_u64);
    let mut x52: u64 = 0;
    let mut x53: u64 = 0;
    ...
    let mut x92: u64 = 0;
    let mut x93: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x92, &mut x93, x91, x80, 0x0_u64);
    let mut x94: u64 = 0;
    let mut x95: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x94, &mut x95, x93, x82, 0x0_u64);
    let mut x96: u64 = 0;
    let mut x97: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x96, &mut x97, x95, x84, 0x0_u64);
    let mut x98: u64 = 0;
    let mut x99: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x98, &mut x99, x97, x86, 0x0_u64);
    let mut x100: u64 = 0;
    let mut x101: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x100, &mut x101, x99, x88, 0x0_u64);
    let mut x102: u64 = 0;
    let mut x103: u64 = 0;
    ...
    fiat_p384_scalar_addcarryx_u64(&mut x142, &mut x143, x141, x130, 0x0_u64);
    let mut x144: u64 = 0;
    let mut x145: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x144, &mut x145, x143, x132, 0x0_u64);
    let mut x146: u64 = 0;
    let mut x147: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x146, &mut x147, x145, x134, 0x0_u64);
    let mut x148: u64 = 0;
    let mut x149: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x148, &mut x149, x147, x136, 0x0_u64);
    let mut x150: u64 = 0;
    let mut x151: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x150, &mut x151, x149, x138, 0x0_u64);
    let mut x152: u64 = 0;
    let mut x153: u64 = 0;
    ...
    fiat_p384_scalar_addcarryx_u64(&mut x192, &mut x193, x191, x180, 0x0_u64);
    let mut x194: u64 = 0;
    let mut x195: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x194, &mut x195, x193, x182, 0x0_u64);
    let mut x196: u64 = 0;
    let mut x197: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x196, &mut x197, x195, x184, 0x0_u64);
    let mut x198: u64 = 0;
    let mut x199: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x198, &mut x199, x197, x186, 0x0_u64);
    let mut x200: u64 = 0;
    let mut x201: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x200, &mut x201, x199, x188, 0x0_u64);
    let mut x202: u64 = 0;
    let mut x203: u64 = 0;
    ...
    fiat_p384_scalar_addcarryx_u64(&mut x242, &mut x243, x241, x230, 0x0_u64);
    let mut x244: u64 = 0;
    let mut x245: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x244, &mut x245, x243, x232, 0x0_u64);
    let mut x246: u64 = 0;
    let mut x247: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x246, &mut x247, x245, x234, 0x0_u64);
    let mut x248: u64 = 0;
    let mut x249: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x248, &mut x249, x247, x236, 0x0_u64);
    let mut x250: u64 = 0;
    let mut x251: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x250, &mut x251, x249, x238, 0x0_u64);
    let mut x252: u64 = 0;
    let mut x253: u64 = 0;
    ...
    fiat_p384_scalar_subborrowx_u64(&mut x302, &mut x303, x301, (x289 as u64), 0x0_u64);
    let mut x304: u64 = 0;
...
/// The function fiat_p384_scalar_to_montgomery translates a field element into
...
///   0 ≤ eval out1 < m
#[inline]
pub fn fiat_p384_scalar_to_montgomery(
    out1: &mut fiat_p384_scalar_montgomery_domain_field_element,
    ...
    let mut x439: u64 = 0;
    let mut x440: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x439, &mut x440, x438, (x426 as u64), 0x0_u64);
    let mut x441: u64 = 0;
...
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]] Output Bounds:
...
/// The function fiat_p384_scalar_to_bytes serializes a field element NOT in the
...
/// The function fiat_p384_scalar_from_bytes deserializes a field element NOT in
/// the Montgomery domain from bytes in little-endian order.
///
/// Preconditions:
///   0 ≤ bytes_eval arg1 < m
/// Postconditions:
...
/// 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~>
/// 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~>
/// 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff], [0x0 ~> 0xff]] Output Bounds:
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
...
/// The function fiat_p384_scalar_set_one returns the field element one in the
/// Montgomery domain.
///
/// Postconditions:
...
/// The function fiat_p384_scalar_msat returns the saturated representation of
/// the prime modulus.
///
/// Postconditions:
...
/// The function fiat_p384_scalar_divstep_precomp returns the precomputed value
/// for Bernstein-Yang-inversion (in montgomery form).
///
/// Postconditions:
///   eval (from_montgomery out1) = ⌊(m - 1) / 2⌋^(if ⌊log2 m⌋ + 1 < 46 then
/// ⌊(49 * (⌊log2 m⌋ + 1) + 80) / 17⌋ else ⌊(49 * (⌊log2 m⌋ + 1) + 57) / 17⌋)
///   0 ≤ eval out1 < m
///
/// Output Bounds:
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
...
///   0 ≤ eval arg5 < m
/// Postconditions:
///   out1 = (if 0 < arg1 ∧ (twos_complement_eval arg3) is odd then 1 - arg1
/// else 1 + arg1)   twos_complement_eval out2 = (if 0 < arg1 ∧
/// (twos_complement_eval arg3) is odd then twos_complement_eval arg3 else
/// twos_complement_eval arg2)   twos_complement_eval out3 = (if 0 < arg1 ∧
/// (twos_complement_eval arg3) is odd then ⌊(twos_complement_eval arg3 -
/// twos_complement_eval arg2) / 2⌋ else ⌊(twos_complement_eval arg3 +
/// (twos_complement_eval arg3 mod 2) * twos_complement_eval arg2) / 2⌋)
///   eval (from_montgomery out4) mod m = (if 0 < arg1 ∧ (twos_complement_eval
/// arg3) is odd then (2 * eval (from_montgomery arg5)) mod m else (2 * eval
/// (from_montgomery arg4)) mod m)   eval (from_montgomery out5) mod m = (if 0 <
/// arg1 ∧ (twos_complement_eval arg3) is odd then (eval (from_montgomery arg4)
/// - eval (from_montgomery arg4)) mod m else (eval (from_montgomery arg5) +
/// (twos_complement_eval arg3 mod 2) * eval (from_montgomery arg4)) mod m)
///   0 ≤ eval out5 < m
///   0 ≤ eval out5 < m
///   0 ≤ eval out2 < m
///   0 ≤ eval out3 < m
...
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]] Output Bounds:
///   out1: [0x0 ~> 0xffffffffffffffff]
///   out2: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff]]   out3: [[0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]   out4: [[0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]   out5: [[0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~>
/// 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub fn fiat_p384_scalar_divstep(
    ...
    let mut x1: u64 = 0;
    let mut x2: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x1, &mut x2, 0x0, (!arg1), 0x1_u64);
    ...
    fiat_p384_scalar_addcarryx_u64(&mut x4, &mut x5, 0x0, (!arg1), 0x1_u64);
    let mut x6: u64 = 0;
    ...
    let mut x14: u64 = 0;
    let mut x15: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x14, &mut x15, 0x0, 0x1_u64, (!(arg2[0])));
    let mut x16: u64 = 0;
    let mut x17: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x16, &mut x17, x15, 0x0_u64, (!(arg2[1])));
    let mut x18: u64 = 0;
    let mut x19: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x18, &mut x19, x17, 0x0_u64, (!(arg2[2])));
    let mut x20: u64 = 0;
    let mut x21: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x20, &mut x21, x19, 0x0_u64, (!(arg2[3])));
    let mut x22: u64 = 0;
    let mut x23: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x22, &mut x23, x21, 0x0_u64, (!(arg2[4])));
    let mut x24: u64 = 0;
    let mut x25: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x24, &mut x25, x23, 0x0_u64, (!(arg2[5])));
    let mut x26: u64 = 0;
    let mut x27: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x26, &mut x27, x25, 0x0_u64, (!(arg2[6])));
    let mut x28: u64 = 0;
    ...
    let mut x65: u64 = 0;
    let mut x66: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x65, &mut x66, x64, (x52 as u64), 0x0_u64);
    let x67: u64 = (arg4[5]);
    let x68: u64 = (arg4[4]);
    let x69: u64 = (arg4[3]);
    let x70: u64 = (arg4[2]);
    ...
    fiat_p384_scalar_subborrowx_u64(&mut x73, &mut x74, 0x0, 0x0_u64, x72);
    let mut x75: u64 = 0;
    let mut x76: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x75, &mut x76, x74, 0x0_u64, x71);
    let mut x77: u64 = 0;
    let mut x78: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x77, &mut x78, x76, 0x0_u64, x70);
    let mut x79: u64 = 0;
    let mut x80: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x79, &mut x80, x78, 0x0_u64, x69);
    let mut x81: u64 = 0;
    let mut x82: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x81, &mut x82, x80, 0x0_u64, x68);
    let mut x83: u64 = 0;
    let mut x84: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_subborrowx_u64(&mut x83, &mut x84, x82, 0x0_u64, x67);
    let mut x85: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x85, x84, 0x0_u64, 0xffffffffffffffff);
    let mut x86: u64 = 0;
    let mut x87: fiat_p384_scalar_u1 = 0;
    ...
    let mut x105: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x105, x104, 0x0_u64, x7);
    let mut x106: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x106, x104, 0x0_u64, x8);
    let mut x107: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x107, x104, 0x0_u64, x9);
    let mut x108: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x108, x104, 0x0_u64, x10);
    let mut x109: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x109, x104, 0x0_u64, x11);
    let mut x110: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x110, x104, 0x0_u64, x12);
    let mut x111: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x111, x104, 0x0_u64, x13);
    let mut x112: u64 = 0;
    ...
    let mut x126: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x126, x104, 0x0_u64, x35);
    let mut x127: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x127, x104, 0x0_u64, x36);
    let mut x128: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x128, x104, 0x0_u64, x37);
    let mut x129: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x129, x104, 0x0_u64, x38);
    let mut x130: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x130, x104, 0x0_u64, x39);
    let mut x131: u64 = 0;
    fiat_p384_scalar_cmovznz_u64(&mut x131, x104, 0x0_u64, x40);
    let mut x132: u64 = 0;
    let mut x133: fiat_p384_scalar_u1 = 0;
    ...
    fiat_p384_scalar_subborrowx_u64(&mut x156, &mut x157, x155, (x143 as u64), 0x0_u64);
    let mut x158: u64 = 0;
    let mut x159: fiat_p384_scalar_u1 = 0;
    fiat_p384_scalar_addcarryx_u64(&mut x158, &mut x159, 0x0, x6, 0x1_u64);
