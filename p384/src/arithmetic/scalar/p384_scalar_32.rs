...
pub const fn fiat_p384_scalar_cmovznz_u32(
    ...
    let x2: u32 = ((((((0x0 as fiat_p384_scalar_i2) - (x1 as fiat_p384_scalar_i2))
        as fiat_p384_scalar_i1) as i64) & (0xffffffff as i64)) as u32);
...
pub const fn fiat_p384_scalar_from_montgomery(
    ...
    let (x74, x75) = fiat_p384_scalar_addcarryx_u32(
        x73,
        (0x0 as u32),
        ((x49 as u32) + x5),
    );
    ...
    let (x172, x173) = fiat_p384_scalar_addcarryx_u32(
        x171,
    ...
    let (x1178, x1179) = fiat_p384_scalar_subborrowx_u32(
        x1177,
        (x1153 as u32),
        (0x0 as u32),
    );
...
pub const fn fiat_p384_scalar_to_montgomery(
    ...
    let mut x131: u32 = 0;
    let mut x132: fiat_p384_scalar_u1 = 0;
    let (x131, x132) = fiat_p384_scalar_addcarryx_u32(
        x130,
        ((x58 as u32) + x14),
        ((x106 as u32) + x62),
    );
    ...
    let (x1741, x1742) = fiat_p384_scalar_subborrowx_u32(
        x1740,
        (x1716 as u32),
        (0x0 as u32),
    );
...
pub const fn fiat_p384_scalar_divstep(
    ...
    let x3: fiat_p384_scalar_u1 = (((x1 >> 31) as fiat_p384_scalar_u1)
        & (((arg3[0]) & (0x1 as u32)) as fiat_p384_scalar_u1));
    let mut x4: u32 = 0;
    ...
    let mut x294: u32 = 0;
    let mut x295: fiat_p384_scalar_u1 = 0;
    let (x294, x295) = fiat_p384_scalar_subborrowx_u32(
        x293,
        (x269 as u32),
        (0x0 as u32),
    );
