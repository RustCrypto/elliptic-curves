//! Autogenerated: fiat-crypto unsaturated-solinas --lang Rust --inline p521 64 '(auto)' '2^521 - 1' carry_add carry_sub carry_opp carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax
...
pub const fn fiat_p521_carry_sub(mut out1: &mut fiat_p521_tight_field_element, arg1: &fiat_p521_tight_field_element, arg2: &fiat_p521_tight_field_element) {
  ...
  let x2: u64 = ((x1 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(1))) - (*IndexConst(arg2).index(1))));
  let x3: u64 = ((x2 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(2))) - (*IndexConst(arg2).index(2))));
  let x4: u64 = ((x3 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(3))) - (*IndexConst(arg2).index(3))));
  let x5: u64 = ((x4 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(4))) - (*IndexConst(arg2).index(4))));
  let x6: u64 = ((x5 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(5))) - (*IndexConst(arg2).index(5))));
  let x7: u64 = ((x6 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(6))) - (*IndexConst(arg2).index(6))));
  let x8: u64 = ((x7 >> 58) + ((0x7fffffffffffffe + (*IndexConst(arg1).index(7))) - (*IndexConst(arg2).index(7))));
  let x9: u64 = ((x8 >> 58) + ((0x3fffffffffffffe + (*IndexConst(arg1).index(8))) - (*IndexConst(arg2).index(8))));
  let x10: u64 = ((x1 & 0x3ffffffffffffff) + (x9 >> 57));
  let x11: u64 = ((((x10 >> 58) as fiat_p521_u1) as u64) + (x2 & 0x3ffffffffffffff));
  let x12: u64 = (x10 & 0x3ffffffffffffff);
  let x13: u64 = (x11 & 0x3ffffffffffffff);
...
pub const fn fiat_p521_carry_opp(mut out1: &mut fiat_p521_tight_field_element, arg1: &fiat_p521_tight_field_element) {
  ...
  let x2: u64 = ((((x1 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(1))));
  let x3: u64 = ((((x2 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(2))));
  let x4: u64 = ((((x3 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(3))));
  let x5: u64 = ((((x4 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(4))));
  let x6: u64 = ((((x5 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(5))));
  let x7: u64 = ((((x6 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(6))));
  let x8: u64 = ((((x7 >> 58) as fiat_p521_u1) as u64) + (0x7fffffffffffffe - (*IndexConst(arg1).index(7))));
  let x9: u64 = ((((x8 >> 58) as fiat_p521_u1) as u64) + (0x3fffffffffffffe - (*IndexConst(arg1).index(8))));
