...
#[inline]
pub const fn fiat_p521_to_bytes(out1: &mut [u8; 66], arg1: &fiat_p521_tight_field_element) {
    let arg1 = &arg1.0;
    let mut x1: u64 = 0;
...
#[inline]
pub const fn fiat_p521_from_bytes(out1: &mut fiat_p521_tight_field_element, arg1: &[u8; 66]) {
    let out1 = &mut out1.0;
