...
//! Autogenerated: './word_by_word_montgomery' --lang Rust --inline p521_scalar 64 0x1fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffa51868783bf2f966b7fcc0148f709a5d03bb5c9b8899c47aebb6fb71e91386409
...
pub const fn fiat_p521_scalar_subborrowx_u64(
    ...
    (
        x3,
        (((0x0 as fiat_p521_scalar_i2) - (x2 as fiat_p521_scalar_i2)) as fiat_p521_scalar_u1),
    )
}
...
pub const fn fiat_p521_scalar_sub(
    ...
    (fiat_p521_scalar_montgomery_domain_field_element([
        x20, x22, x24, x26, x28, x30, x32, x34, x36,
    ]))
}
...
pub const fn fiat_p521_scalar_from_montgomery(
    ...
    (fiat_p521_scalar_non_montgomery_domain_field_element([
        x637, x638, x639, x640, x641, x642, x643, x644, x645,
    ]))
}
...
pub const fn fiat_p521_scalar_to_montgomery(
    ...
    (fiat_p521_scalar_montgomery_domain_field_element([
        x967, x968, x969, x970, x971, x972, x973, x974, x975,
    ]))
}
...
pub const fn fiat_p521_scalar_from_bytes(arg1: &[u8; 66]) -> [u64; 9] {
    ...
    ([x73, x80, x87, x94, x101, x108, x115, x122, x123])
}
