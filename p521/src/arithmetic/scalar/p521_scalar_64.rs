...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p521_scalar_addcarryx_u64(out1: &mut u64, out2: &mut fiat_p521_scalar_u1, arg1: fiat_p521_scalar_u1, arg2: u64, arg3: u64) {
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub fn fiat_p521_scalar_subborrowx_u64(out1: &mut u64, out2: &mut fiat_p521_scalar_u1, arg1: fiat_p521_scalar_u1, arg2: u64, arg3: u64) {
...
#[inline]
pub fn fiat_p521_scalar_mulx_u64(out1: &mut u64, out2: &mut u64, arg1: u64, arg2: u64) {
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub fn fiat_p521_scalar_cmovznz_u64(out1: &mut u64, arg1: fiat_p521_scalar_u1, arg2: u64, arg3: u64) {
  let x1: fiat_p521_scalar_u1 = (!(!arg1));
  let x2: u64 = ((((((0x0 as fiat_p521_scalar_i2) - (x1 as fiat_p521_scalar_i2)) as fiat_p521_scalar_i1) as i128) & (0xffffffffffffffff as i128)) as u64);
...
///
#[inline]
pub fn fiat_p521_scalar_mul(out1: &mut fiat_p521_scalar_montgomery_domain_field_element, arg1: &fiat_p521_scalar_montgomery_domain_field_element, arg2: &fiat_p521_scalar_montgomery_domain_field_element) {
  let x1: u64 = (arg1[1]);
  let x2: u64 = (arg1[2]);
  let x3: u64 = (arg1[3]);
  let x4: u64 = (arg1[4]);
...
///
#[inline]
pub fn fiat_p521_scalar_square(out1: &mut fiat_p521_scalar_montgomery_domain_field_element, arg1: &fiat_p521_scalar_montgomery_domain_field_element) {
  let x1: u64 = (arg1[1]);
  let x2: u64 = (arg1[2]);
  let x3: u64 = (arg1[3]);
  let x4: u64 = (arg1[4]);
...
///
#[inline]
pub fn fiat_p521_scalar_add(out1: &mut fiat_p521_scalar_montgomery_domain_field_element, arg1: &fiat_p521_scalar_montgomery_domain_field_element, arg2: &fiat_p521_scalar_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
...
///
#[inline]
pub fn fiat_p521_scalar_sub(out1: &mut fiat_p521_scalar_montgomery_domain_field_element, arg1: &fiat_p521_scalar_montgomery_domain_field_element, arg2: &fiat_p521_scalar_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p521_scalar_u1 = 0;
...
///
#[inline]
pub fn fiat_p521_scalar_opp(out1: &mut fiat_p521_scalar_montgomery_domain_field_element, arg1: &fiat_p521_scalar_montgomery_domain_field_element) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p521_scalar_u1 = 0;
...
///
#[inline]
pub fn fiat_p521_scalar_from_montgomery(out1: &mut fiat_p521_scalar_non_montgomery_domain_field_element, arg1: &fiat_p521_scalar_montgomery_domain_field_element) {
  let x1: u64 = (arg1[0]);
  let mut x2: u64 = 0;
  let mut x3: u64 = 0;
  ...
  let mut x124: u64 = 0;
  let mut x125: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x124, &mut x125, x123, ((x71 as u64) + ((x55 as u64) + ((x37 as u64) + x5))), x106);
  let mut x126: u64 = 0;
  let mut x127: fiat_p521_scalar_u1 = 0;
  ...
  let mut x194: u64 = 0;
  let mut x195: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x194, &mut x195, x193, ((x141 as u64) + ((x125 as u64) + ((x107 as u64) + x75))), x176);
  let mut x196: u64 = 0;
  let mut x197: fiat_p521_scalar_u1 = 0;
  ...
  let mut x264: u64 = 0;
  let mut x265: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x264, &mut x265, x263, ((x211 as u64) + ((x195 as u64) + ((x177 as u64) + x145))), x246);
  let mut x266: u64 = 0;
  let mut x267: fiat_p521_scalar_u1 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x334, &mut x335, x333, ((x281 as u64) + ((x265 as u64) + ((x247 as u64) + x215))), x316);
  let mut x336: u64 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x404, &mut x405, x403, ((x351 as u64) + ((x335 as u64) + ((x317 as u64) + x285))), x386);
  let mut x406: u64 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x474, &mut x475, x473, ((x421 as u64) + ((x405 as u64) + ((x387 as u64) + x355))), x456);
  let mut x476: u64 = 0;
  let mut x477: fiat_p521_scalar_u1 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x544, &mut x545, x543, ((x491 as u64) + ((x475 as u64) + ((x457 as u64) + x425))), x526);
  let mut x546: u64 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x614, &mut x615, x613, ((x561 as u64) + ((x545 as u64) + ((x527 as u64) + x495))), x596);
...
///
#[inline]
pub fn fiat_p521_scalar_to_montgomery(out1: &mut fiat_p521_scalar_montgomery_domain_field_element, arg1: &fiat_p521_scalar_non_montgomery_domain_field_element) {
  let x1: u64 = (arg1[1]);
  let x2: u64 = (arg1[2]);
  let x3: u64 = (arg1[3]);
  let x4: u64 = (arg1[4]);
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x148, &mut x149, x147, (((x97 as u64) + ((x43 as u64) + x11)) + ((x79 as u64) + x47)), x130);
  let mut x150: u64 = 0;
  let mut x151: u64 = 0;
  ...
  let mut x254: u64 = 0;
  let mut x255: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x254, &mut x255, x253, (((x203 as u64) + ((x149 as u64) + ((x131 as u64) + x99))) + ((x185 as u64) + x153)), x236);
  let mut x256: u64 = 0;
  let mut x257: u64 = 0;
  ...
  let mut x360: u64 = 0;
  let mut x361: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x360, &mut x361, x359, (((x309 as u64) + ((x255 as u64) + ((x237 as u64) + x205))) + ((x291 as u64) + x259)), x342);
  let mut x362: u64 = 0;
  let mut x363: u64 = 0;
  ...
  let mut x466: u64 = 0;
  let mut x467: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x466, &mut x467, x465, (((x415 as u64) + ((x361 as u64) + ((x343 as u64) + x311))) + ((x397 as u64) + x365)), x448);
  let mut x468: u64 = 0;
  let mut x469: u64 = 0;
  ...
  let mut x572: u64 = 0;
  let mut x573: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x572, &mut x573, x571, (((x521 as u64) + ((x467 as u64) + ((x449 as u64) + x417))) + ((x503 as u64) + x471)), x554);
  let mut x574: u64 = 0;
  let mut x575: u64 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x678, &mut x679, x677, (((x627 as u64) + ((x573 as u64) + ((x555 as u64) + x523))) + ((x609 as u64) + x577)), x660);
  let mut x680: u64 = 0;
  let mut x681: u64 = 0;
  ...
  fiat_p521_scalar_addcarryx_u64(&mut x784, &mut x785, x783, (((x733 as u64) + ((x679 as u64) + ((x661 as u64) + x629))) + ((x715 as u64) + x683)), x766);
  let mut x786: u64 = 0;
  let mut x787: u64 = 0;
  ...
  let mut x890: u64 = 0;
  let mut x891: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x890, &mut x891, x889, (((x839 as u64) + ((x785 as u64) + ((x767 as u64) + x735))) + ((x821 as u64) + x789)), x872);
  let mut x892: u64 = 0;
  let mut x893: u64 = 0;
  ...
  let x946: u64 = (((x945 as u64) + ((x891 as u64) + ((x873 as u64) + x841))) + ((x927 as u64) + x895));
  let mut x947: u64 = 0;
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub fn fiat_p521_scalar_nonzero(out1: &mut u64, arg1: &[u64; 9]) {
  let x1: u64 = ((arg1[0]) | ((arg1[1]) | ((arg1[2]) | ((arg1[3]) | ((arg1[4]) | ((arg1[5]) | ((arg1[6]) | ((arg1[7]) | (arg1[8])))))))));
  *out1 = x1;
}
...
#[inline]
pub fn fiat_p521_scalar_selectznz(out1: &mut [u64; 9], arg1: fiat_p521_scalar_u1, arg2: &[u64; 9], arg3: &[u64; 9]) {
  let mut x1: u64 = 0;
...
#[inline]
pub fn fiat_p521_scalar_to_bytes(out1: &mut [u8; 66], arg1: &[u64; 9]) {
  let x1: u64 = (arg1[8]);
  let x2: u64 = (arg1[7]);
  let x3: u64 = (arg1[6]);
  let x4: u64 = (arg1[5]);
...
#[inline]
pub fn fiat_p521_scalar_from_bytes(out1: &mut [u64; 9], arg1: &[u8; 66]) {
...
///
#[inline]
pub fn fiat_p521_scalar_set_one(out1: &mut fiat_p521_scalar_montgomery_domain_field_element) {
...
#[inline]
pub fn fiat_p521_scalar_msat(out1: &mut [u64; 10]) {
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub fn fiat_p521_scalar_divstep_precomp(out1: &mut [u64; 9]) {
...
#[inline]
pub fn fiat_p521_scalar_divstep(out1: &mut u64, out2: &mut [u64; 10], out3: &mut [u64; 10], out4: &mut [u64; 9], out5: &mut [u64; 9], arg1: u64, arg2: &[u64; 10], arg3: &[u64; 10], arg4: &[u64; 9], arg5: &[u64; 9]) {
  let mut x1: u64 = 0;
  let mut x2: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x1, &mut x2, 0x0, (!arg1), (0x1 as u64));
  let x3: fiat_p521_scalar_u1 = (((x1 >> 63) as fiat_p521_scalar_u1) & (((arg3[0]) & (0x1 as u64)) as fiat_p521_scalar_u1));
  let mut x4: u64 = 0;
  ...
  let mut x124: u64 = 0;
  let mut x125: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x124, &mut x125, x123, x105, (x121 & 0x3bb5c9b8899c47ae));
  let mut x126: u64 = 0;
  let mut x127: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x126, &mut x127, x125, x107, (x121 & 0x7fcc0148f709a5d0));
  let mut x128: u64 = 0;
  let mut x129: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x128, &mut x129, x127, x109, (x121 & 0x51868783bf2f966b));
  let mut x130: u64 = 0;
  let mut x131: fiat_p521_scalar_u1 = 0;
  fiat_p521_scalar_addcarryx_u64(&mut x130, &mut x131, x129, x111, (x121 & 0xfffffffffffffffa));
  let mut x132: u64 = 0;
  let mut x133: fiat_p521_scalar_u1 = 0;
