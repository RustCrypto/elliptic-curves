...
#[inline]
pub const fn fiat_p521_scalar_to_bytes(out1: &mut [u8; 66], arg1: &[u64; 9]) {
    let x1: u64 = (arg1[8]);
    let x2: u64 = (arg1[7]);
    let x3: u64 = (arg1[6]);
    let x4: u64 = (arg1[5]);
...
#[inline]
pub const fn fiat_p521_scalar_from_bytes(out1: &mut [u64; 9], arg1: &[u8; 66]) {
...
///
#[inline]
pub const fn fiat_p521_scalar_set_one(out1: &mut fiat_p521_scalar_montgomery_domain_field_element) {
    let out1 = &mut out1.0;
...
#[inline]
pub const fn fiat_p521_scalar_msat(out1: &mut [u64; 10]) {
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p521_scalar_divstep_precomp(out1: &mut [u64; 9]) {
