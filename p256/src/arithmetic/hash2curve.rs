...
impl hash2curve::GroupDigest for NistP256 {
    const HASH_TO_CURVE_DST: &[u8] = b"P256_XMD:SHA-256_SSWU_RO_";
    const ENCODE_TO_CURVE_DST: &[u8] = b"P256_XMD:SHA-256_SSWU_NU_";
...
mod tests {
    ...
    fn hash_to_curve() {
        ...
        for test_vector in TEST_VECTORS {
            ...
            let u = hash2curve::hash_to_field::<
                ...
                FieldElement,
                <NistP256 as MapToCurve>::FieldLength,
            >(&[test_vector.msg], &[DST])
            .unwrap();
    ...
    fn hash_to_scalar_voprf() {
        ...
        'outer: for test_vector in TEST_VECTORS {
            ...
            for counter in 0_u8..=u8::MAX {
                let scalar = hash2curve::hash_to_scalar::<NistP256, ExpandMsgXmd<Sha256>>(
                    &[
                        test_vector.seed,
                        &key_info_len,
    ...
    fn from_okm_fuzz() {
        ...
        let wide_order = NonZero::<U384>::from_be_byte_array(wide_order).unwrap();
