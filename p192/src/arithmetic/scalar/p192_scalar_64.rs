...
//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline p192_scalar 64 0xffffffffffffffffffffffff99def836146bc9b1b4d22831 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub const fn fiat_p192_scalar_nonzero(out1: &mut u64, arg1: &[u64; 3]) {
...
#[inline]
pub const fn fiat_p192_scalar_to_bytes(out1: &mut [u8; 24], arg1: &[u64; 3]) {
    let x1: u64 = (arg1[2]);
    let x2: u64 = (arg1[1]);
    let x3: u64 = (arg1[0]);
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p192_scalar_from_bytes(out1: &mut [u64; 3], arg1: &[u8; 24]) {
...
#[inline]
pub const fn fiat_p192_scalar_msat(out1: &mut [u64; 4]) {
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p192_scalar_divstep_precomp(out1: &mut [u64; 3]) {
