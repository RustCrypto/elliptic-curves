...
//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline p224 32 '2^224 - 2^96 + 1' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out1: [0x0 ~> 0xffffffff]
#[inline]
pub const fn fiat_p224_nonzero(out1: &mut u32, arg1: &[u32; 7]) {
    let x1: u32 = ((arg1[0])
...
#[inline]
pub const fn fiat_p224_to_bytes(out1: &mut [u8; 28], arg1: &[u32; 7]) {
    let x1: u32 = (arg1[6]);
    let x2: u32 = (arg1[5]);
    let x3: u32 = (arg1[4]);
    let x4: u32 = (arg1[3]);
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
#[inline]
pub const fn fiat_p224_from_bytes(out1: &mut [u32; 7], arg1: &[u8; 28]) {
...
///
#[inline]
pub const fn fiat_p224_set_one(out1: &mut fiat_p224_montgomery_domain_field_element) {
    let out1 = &mut out1.0;
    out1[0] = 0xffffffff;
    out1[1] = 0xffffffff;
    out1[2] = 0xffffffff;
...
#[inline]
pub const fn fiat_p224_msat(out1: &mut [u32; 8]) {
    out1[0] = (0x1 as u32);
    out1[1] = (0x0 as u32);
    out1[2] = (0x0 as u32);
    out1[3] = 0xffffffff;
...
///   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
#[inline]
pub const fn fiat_p224_divstep_precomp(out1: &mut [u32; 7]) {
    out1[0] = 0x800000;
    out1[1] = 0x800000;
    out1[2] = 0xfe000000;
    out1[3] = 0xffffff;
