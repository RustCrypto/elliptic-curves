...
//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline p224_scalar 64 26959946667150639794667015087019625940457807714424391721682722368061 mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out1: [0x0 ~> 0xffffffffffffffff]
#[inline]
pub const fn fiat_p224_scalar_nonzero(out1: &mut u64, arg1: &[u64; 4]) {
...
#[inline]
pub const fn fiat_p224_scalar_to_bytes(out1: &mut [u8; 28], arg1: &[u64; 4]) {
    let x1: u64 = (arg1[3]);
    let x2: u64 = (arg1[2]);
    let x3: u64 = (arg1[1]);
    let x4: u64 = (arg1[0]);
...
#[inline]
pub const fn fiat_p224_scalar_from_bytes(out1: &mut [u64; 4], arg1: &[u8; 28]) {
...
#[inline]
pub const fn fiat_p224_scalar_msat(out1: &mut [u64; 5]) {
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_p224_scalar_divstep_precomp(out1: &mut [u64; 4]) {
