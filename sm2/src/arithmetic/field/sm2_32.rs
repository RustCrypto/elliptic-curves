//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline sm2 32 0xfffffffeffffffffffffffffffffffffffffffff00000000ffffffffffffffff mul square add sub opp from_montgomery to_montgomery selectznz msat divstep divstep_precomp
...
pub const fn fiat_sm2_mul(
    mut out1: &mut fiat_sm2_montgomery_domain_field_element,
...
pub const fn fiat_sm2_from_montgomery(
    mut out1: &mut fiat_sm2_non_montgomery_domain_field_element,
    arg1: &fiat_sm2_montgomery_domain_field_element,
) {
...
pub const fn fiat_sm2_divstep(
    ...
    let x3: fiat_sm2_u1 = (((x1 >> 31) as fiat_sm2_u1)
        & (((*IndexConst(arg3).index(0)) & (0x1 as u32)) as fiat_sm2_u1));
    let mut x4: u32 = 0;
