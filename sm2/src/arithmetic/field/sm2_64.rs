//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline sm2 64 0xfffffffeffffffffffffffffffffffffffffffff00000000ffffffffffffffff mul square add sub opp from_montgomery to_montgomery selectznz msat divstep divstep_precomp
...
pub const fn fiat_sm2_divstep(
    ...
    let x3: fiat_sm2_u1 = (((x1 >> 63) as fiat_sm2_u1)
        & (((*IndexConst(arg3).index(0)) & (0x1 as u64)) as fiat_sm2_u1));
    let mut x4: u64 = 0;
