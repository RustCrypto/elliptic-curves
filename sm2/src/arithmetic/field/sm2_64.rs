...
//! Autogenerated: fiat-crypto word-by-word-montgomery --lang Rust --inline sm2 64 0xfffffffeffffffffffffffffffffffffffffffff00000000ffffffffffffffff mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
///   out2: [0x0 ~> 0x1]
#[inline]
pub const fn fiat_sm2_addcarryx_u64(
    out1: &mut u64,
...
#[inline]
pub const fn fiat_sm2_to_bytes(out1: &mut [u8; 32], arg1: &[u64; 4]) {
    let x1: u64 = (arg1[3]);
    let x2: u64 = (arg1[2]);
    let x3: u64 = (arg1[1]);
    let x4: u64 = (arg1[0]);
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_sm2_from_bytes(out1: &mut [u64; 4], arg1: &[u8; 32]) {
...
#[inline]
pub const fn fiat_sm2_msat(out1: &mut [u64; 5]) {
...
///   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
#[inline]
pub const fn fiat_sm2_divstep_precomp(out1: &mut [u64; 4]) {
